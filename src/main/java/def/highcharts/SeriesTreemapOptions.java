 ...
 *
 * You have to extend the `SeriesTreemapOptions` via an interface to allow custom properties: ``` declare interface SeriesTreemapOptions { customProperty:
 * string; }
 *
 */
@jsweet.lang.Interface
@jsweet.lang.Extends({ SeriesOptions.class })
public abstract class SeriesTreemapOptions extends PlotTreemapOptions {
	/**
	 ...
	 * sources.
	 */
	public def.highcharts.StringTypes.treemap type;
	/**
