...
/**
 * (Highstock) An `AO` series. If the type option is not specified, it is inherited from chart.type.
 *
 ...
 *
 * You have to extend the `SeriesAoOptions` via an interface to allow custom properties: ``` declare interface SeriesAoOptions { customProperty: string; }
 *
 */
@jsweet.lang.Interface
@jsweet.lang.Extends({ SeriesOptions.class })
public abstract class SeriesAoOptions extends PlotAoOptions {
	/**
	 * Not available
	 */
	 ...
	 * sources.
	 */
	public def.highcharts.StringTypes.ao type;
	/**
