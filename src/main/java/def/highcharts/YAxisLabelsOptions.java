...
public abstract class YAxisLabelsOptions extends def.js.Object {
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) What part of the string the given position is anchored to. Can be one of `"left"`, `"center"` or `"right"`. The
	 * exact position also depends on the `labels.x` setting.
	 *
	...
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) A format string for the axis label.
	 */
	@jsweet.lang.Optional
	public String format;
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) Callback JavaScript function to format the label. The value is given by `this.value`. Additional properties for
	 ...
	 */
	@jsweet.lang.Optional
	public Array<YAxisLabelsLevelsOptions> levels;
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) How to handle overflowing labels on horizontal axis. If set to `"allow"`, it will not be aligned at all. By
	 * default it `"justify"` labels inside the chart area. If there is room to move it, it will be aligned to the edge, else it will be removed.
	 */
	@jsweet.lang.Optional
	...
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) Rotation of the labels in degrees.
	 */
	@jsweet.lang.Optional
	...
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) Horizontal axes only. The number of lines to spread the labels over to make room or tighter labels.
	 */
	@jsweet.lang.Optional
	...
	public double step;
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) CSS styles for the label. Use `whiteSpace: 'nowrap'` to prevent wrapping of category labels. Use `textOverflow:
	 ...
	 */
	@jsweet.lang.Optional
	public YAxisLabelsSymbolOptions symbol;
	/**
	...
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) The x position offset of all labels relative to the tick positions on the axis. Defaults to -15 for left axis,
	 * 15 for right axis.
	 */
	@jsweet.lang.Optional
	public double x;
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) The y position offset of all labels relative to the tick positions on the axis. For polar and radial axis
	 * consider the use of the distance option.
	 */
	@jsweet.lang.Optional
	public double y;
	/**
