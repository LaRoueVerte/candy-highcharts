...
/**
 * (Highcharts) A `packedbubble` series. If the type option is not specified, it is inherited from chart.type.
 *
 ...
 *
 * You have to extend the `SeriesPackedbubbleOptions` via an interface to allow custom properties: ``` declare interface SeriesPackedbubbleOptions {
 * customProperty: string; }
 *
 */
@jsweet.lang.Interface
@jsweet.lang.Extends({ SeriesOptions.class })
public abstract class SeriesPackedbubbleOptions extends PlotPackedbubbleOptions {
	/**
	 * (Highcharts) An array of data points for the series. For the `packedbubble` series type, points can be given in the following ways:
	 *
	 * 1. An array of `values`. (see online documentation for example)
	 *
	 * 2. An array of objects with named values. The objects are point configuration objects as seen below. If the total number of data points exceeds the
	 * series' turboThreshold, this option is not available. (see online documentation for example)
	 */
	@jsweet.lang.Optional
	public jsweet.util.union.Union<PointOptionsObject, Array<jsweet.util.union.Union<Object, Object[]>>> data;
	/**
	 * Not available
	 */
	@jsweet.lang.Optional
	 ...
	 * sources.
	 */
	public def.highcharts.StringTypes.packedbubble type;
	/**
