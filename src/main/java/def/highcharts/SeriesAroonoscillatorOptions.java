...
/**
 * (Highstock) An `Aroon Oscillator` series. If the type option is not specified, it is inherited from chart.type.
 *
 ...
 *
 * 2. Options for all `aroonoscillator` series are defined in plotOptions.aroonoscillator.
 *
 * 3. Options for one single series are given in the series instance array. (see online documentation for example)
 *
 * You have to extend the `SeriesAroonoscillatorOptions` via an interface to allow custom properties: ``` declare interface SeriesAroonoscillatorOptions {
 * customProperty: string; }
 *
 */
@jsweet.lang.Interface
@jsweet.lang.Extends({ SeriesOptions.class })
public abstract class SeriesAroonoscillatorOptions extends PlotAroonoscillatorOptions {
	/**
	 * Not available
	 */
	@jsweet.lang.Optional
	public Object aroonDown;
	/**
	 * Not available
	 */
	@jsweet.lang.Optional
	 ...
	 * sources.
	 */
	public def.highcharts.StringTypes.aroonoscillator type;
	/**
