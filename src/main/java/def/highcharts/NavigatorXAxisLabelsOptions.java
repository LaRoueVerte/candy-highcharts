...
public abstract class NavigatorXAxisLabelsOptions extends def.js.Object {
	/**
	 * (Highstock, Gantt) What part of the string the given position is anchored to. If `left`, the left side of the string is at the axis position. Can be one
	 * of `"left"`, `"center"` or `"right"`. Defaults to an intelligent guess based on which side of the chart the axis is on and the rotation of the label.
	 */
	...
	/**
	 * (Highstock, Gantt) The x position offset of all labels relative to the tick positions on the axis.
	 */
	@jsweet.lang.Optional
	public double x;
	/**
	 * (Highstock, Gantt) The y position offset of all labels relative to the tick positions on the axis. The default makes it adapt to the font size of the
	 * bottom axis.
	 */
	@jsweet.lang.Optional
	public double y;
