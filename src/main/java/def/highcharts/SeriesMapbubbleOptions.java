...
/**
 * (Highmaps) A `mapbubble` series. If the type option is not specified, it is inherited from chart.type.
 *
 ...
 *
 * You have to extend the `SeriesMapbubbleOptions` via an interface to allow custom properties: ``` declare interface SeriesMapbubbleOptions { customProperty:
 * string; }
 *
 */
@jsweet.lang.Interface
@jsweet.lang.Extends({ SeriesOptions.class })
public abstract class SeriesMapbubbleOptions extends PlotMapbubbleOptions {
	/**
	 * (Highmaps) An array of data points for the series. For the `mapbubble` series type, points can be given in the following ways:
	 *
	...
	public Array<Union3<Double, Object, SeriesMapbubbleDataOptions>> data;
	/**
	 * Not available
	 */
	@jsweet.lang.Optional
	 ...
	 * sources.
	 */
	public def.highcharts.StringTypes.mapbubble type;
	/**
