...
public abstract class SeriesWindbarbOptions extends PlotWindbarbOptions {
    /**
    ...
    public Array<jsweet.util.union.Union<jsweet.util.tuple.Tuple3<jsweet.util.union.Union<Double,String>,Double,Double>,PointOptionsObject>> data;
    /**
     * Not available
     */
    @jsweet.lang.Optional
     ...
     * unknown sources.
     */
    public def.highcharts.StringTypes.windbarb type;
    /**
