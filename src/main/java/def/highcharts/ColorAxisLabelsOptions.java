...
public abstract class ColorAxisLabelsOptions extends def.js.Object {
	/**
	 * (Highcharts, Highstock, Highmaps) What part of the string the given position is anchored to. If `left`, the left side of the string is at the axis
	...
	/**
	 * (Highcharts, Highstock, Highmaps) Callback JavaScript function to format the label. The value is given by `this.value`. Additional properties for `this`
	 * are `axis`, `chart`, `isFirst` and `isLast`. The value of the default label formatter can be retrieved by calling
	...
	/**
	 * (Highcharts, Highstock, Highmaps) How to handle overflowing labels on horizontal color axis. If set to `"allow"`, it will not be aligned at all. By
	...
	/**
	 * (Highcharts, Highstock, Highmaps) Horizontal axes only. The number of lines to spread the labels over to make room or tighter labels.
	 */
	@jsweet.lang.Optional
	...
	public double step;
	/**
	 * (Highcharts, Highstock, Highmaps) CSS styles for the label. Use `whiteSpace: 'nowrap'` to prevent wrapping of category labels. Use `textOverflow: 'none'`
	...
	/**
	 * (Highcharts, Highstock, Highmaps) The x position offset of all labels relative to the tick positions on the axis.
	 */
	@jsweet.lang.Optional
	public double x;
	/**
	 * (Highcharts, Highstock, Highmaps) The y position offset of all labels relative to the tick positions on the axis. The default makes it adapt to the font
