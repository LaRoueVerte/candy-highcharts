...
public abstract class SeriesBoxplotOptions extends PlotBoxplotOptions {
    /**
    ...
    public Array<Union3<jsweet.util.tuple.Tuple5<jsweet.util.union.Union<Double,String>,Double,Double,Double,Double>,jsweet.util.tuple.Tuple6<jsweet.util.union.Union<Double,String>,Double,Double,Double,Double,Double>,PointOptionsObject>> data;
    /**
     * Not available
     */
    @jsweet.lang.Optional
     ...
     * unknown sources.
     */
    public def.highcharts.StringTypes.boxplot type;
    /**
