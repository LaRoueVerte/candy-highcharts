...
public abstract class PlotVariablepieOptions extends def.js.Object {
    /**
     ...
     */
    @jsweet.lang.Optional
    public Union3<Boolean,PlotVariablepieAnimationOptions,Partial2<AnimationOptionsObject>> animation;
    /**
     ...
     */
    @jsweet.lang.Optional
    public jsweet.util.tuple.Tuple2<Union3<Double,String,Object>,Union3<Double,String,Object>> center;
    /**
     ...
     */
    @jsweet.lang.Optional
    public jsweet.util.union.Union<Double,String> maxPointSize;
    /**
     * (Highcharts) The minimum size of the points' radius related to chart's
     * `plotArea`. If a number is set, it applies in pixels.
     */
    @jsweet.lang.Optional
    public jsweet.util.union.Union<Double,String> minPointSize;
    /**
     ...
     */
    @jsweet.lang.Optional
    public jsweet.util.union.Union<def.highcharts.StringTypes.area,def.highcharts.StringTypes.radius> sizeBy;
    /**
