...
public abstract class SeriesVariablepieOptions extends PlotVariablepieOptions {
    /**
    ...
    public Array<jsweet.util.union.Union<jsweet.util.tuple.Tuple2<jsweet.util.union.Union<Double,String>,Double>,PointOptionsObject>> data;
    /**
     * Not available
     */
    @jsweet.lang.Optional
     ...
     * unknown sources.
     */
    public def.highcharts.StringTypes.variablepie type;
    /**
     * Not available
     */
    @jsweet.lang.Optional
