...
public abstract class XAxisLabelsOptions extends def.js.Object {
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) What part of the string the given position is anchored to. If `left`, the left side of the string is at the axis
	 * position. Can be one of `"left"`, `"center"` or `"right"`. Defaults to an intelligent guess based on which side of the chart the axis is on and the
	...
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) The x position offset of all labels relative to the tick positions on the axis.
	 */
	@jsweet.lang.Optional
	public double x;
	/**
	 * (Highcharts, Highstock, Highmaps, Gantt) The y position offset of all labels relative to the tick positions on the axis. The default makes it adapt to
