...
public abstract class SeriesVectorOptions extends PlotVectorOptions {
    /**
    ...
    public Array<jsweet.util.union.Union<jsweet.util.tuple.Tuple4<jsweet.util.union.Union<Double,String>,Double,Double,Double>,PointOptionsObject>> data;
    /**
     * Not available
     */
    @jsweet.lang.Optional
     ...
     * unknown sources.
     */
    public def.highcharts.StringTypes.vector type;
    /**
