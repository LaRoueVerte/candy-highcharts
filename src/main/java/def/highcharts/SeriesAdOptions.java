...
/**
 * (Highstock) A `AD` series. If the type option is not specified, it is inherited from chart.type.
 *
 ...
 *
 * You have to extend the `SeriesAdOptions` via an interface to allow custom properties: ``` declare interface SeriesAdOptions { customProperty: string; }
 *
 */
@jsweet.lang.Interface
@jsweet.lang.Extends({ SeriesOptions.class })
public abstract class SeriesAdOptions extends PlotAdOptions {
	/**
	 * Not available
	 */
	 ...
	 * sources.
	 */
	public def.highcharts.StringTypes.ad type;
	/**
