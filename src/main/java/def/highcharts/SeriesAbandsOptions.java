...
/**
 * (Highstock) An Acceleration bands indicator. If the type option is not specified, it is inherited from chart.type.
 *
 ...
 *
 * You have to extend the `SeriesAbandsOptions` via an interface to allow custom properties: ``` declare interface SeriesAbandsOptions { customProperty: string;
 * }
 *
 */
@jsweet.lang.Interface
@jsweet.lang.Extends({ SeriesOptions.class })
public abstract class SeriesAbandsOptions extends PlotAbandsOptions {
	/**
	 * Not available
	 */
	 ...
	 * sources.
	 */
	public def.highcharts.StringTypes.abands type;
	/**
