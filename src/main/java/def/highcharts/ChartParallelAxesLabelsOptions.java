...
public abstract class ChartParallelAxesLabelsOptions extends def.js.Object {
	/**
	 * (Highcharts) What part of the string the given position is anchored to. Can be one of `"left"`, `"center"` or `"right"`. The exact position also depends
	 * on the `labels.x` setting.
	 *
	 ...
	 */
	@jsweet.lang.Optional
	public Array<ChartParallelAxesLabelsLevelsOptions> levels;
	/**
	 ...
	 */
	@jsweet.lang.Optional
	public ChartParallelAxesLabelsSymbolOptions symbol;
	/**
	...
	public double x;
	/**
	 * (Highcharts) The y position offset of all labels relative to the tick positions on the axis. For polar and radial axis consider the use of the distance
	 * option.
	 */
	@jsweet.lang.Optional
	public double y;
